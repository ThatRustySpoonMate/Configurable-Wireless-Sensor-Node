...
#define MQTT_TOPIC_AQI_STR CONCATENATE(MQTT_TOPIC_LOCATION_SLUG, AQI_TOPIC_SUFFIC)
#define MQTT_TOPIC_TVOC_STR CONCATENATE(MQTT_TOPIC_LOCATION_SLUG, TVOC_TOPIC_SUFFIC)
#define MQTT_TOPIC_ECO2_STR CONCATENATE(MQTT_TOPIC_LOCATION_SLUG, ECO2_TOPIC_SUFFIC)
...
#define MQTT_TOPIC_ERRORS_STR  CONCATENATE(MQTT_TOPIC_LOCATION_SLUG, ERRORS_TOPIC_SUFFIX)
...
const char *MQTT_TOPIC_AQI = MQTT_TOPIC_AQI_STR;
const char *MQTT_TOPIC_TVOC = MQTT_TOPIC_TVOC_STR;
const char *MQTT_TOPIC_ECO2 = MQTT_TOPIC_ECO2_STR;
...
const char *MQTT_TOPIC_ERRORS = MQTT_TOPIC_ERRORS_STR;
